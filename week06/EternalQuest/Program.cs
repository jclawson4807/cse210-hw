...
class Program
{
    static void Main(string[] args)
    {
        ...
        3) I added checks in many places to prevent the program from crashing due to user error.  For example, the system verifies a file exists before accessing it.  It also uses try catch blocks for int conversions when getting numbers entered by the user from the prompt.
        */
